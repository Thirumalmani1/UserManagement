...
<html>
  ...
  <body>
    ...
    <div class="container">
      <h2> Edit User </h2><br/>
      <form method="post" action="{{url('/users_info/update')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4 {{ $errors->has('number') ? ' has-error' : '' }}">
              ...
              <input type="text" class="form-control" name="number" value="{{$user->phone_number}}">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4 {{ $errors->has('country') ? ' has-error' : '' }}">
            ...
            <input class="date form-control"  type="text" name="country" value="{{$user->country}}"> 
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4 {{ $errors->has('date') ? ' has-error' : '' }}">
            <strong>D.O.B : </strong>  
            <input class="date form-control"  type="text" id="datepicker" name="date" value="{{$user->date_of_birth}}">
